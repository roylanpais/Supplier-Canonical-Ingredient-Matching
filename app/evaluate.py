...
def evaluate_matches():
    ...
    # Load generated matches and ground truth
    try:
    ...
    # Ensure IDs are strings for safe merging
    ...
    # 1. Precision@1 (Overall): 
    #    How many items' *best* prediction was correct, regardless of confidence?
    correct_top_1 = (merged_df['ingredient_id_pred'] == merged_df['ingredient_id_true']).sum()
    precision_at_1 = correct_top_1 / total_items

    # 2. Coverage:
    #    What percentage of items received a confidence score >= threshold?
    ...
    # 3. Precision of Covered:
    #    Of the items that met the confidence threshold, how many were correct?
